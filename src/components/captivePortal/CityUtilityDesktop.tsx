...
interface CityUtilityDesktopProps {
  title: string;
  subtitle?: string;
...
export function CityUtilityDesktop({ title, subtitle, language, config }: CityUtilityDesktopProps) {
  ...
  return (
    ...
    <section className="cityUtility px-6 mt-0">
      ...
      >
        {/* Weather */}
        <div className="rounded-xl bg-white/5 border border-white/10 p-3" style={{ gridArea: 'weather' }}>
        ...
        {/* Local time */}
        <div className="rounded-xl bg-white/5 border border-white/10 p-3" style={{ gridArea: 'localTime' }}>
        ...
        {/* Currency */}
        <div className="rounded-xl bg-white/5 border border-white/10 p-3" style={{ gridArea: 'currency' }}>
