...
export const FeaturedBanner: React.FC<FeaturedBannerProps> = ({ banner, language }) => {
  ...
  return (
    <div className="featuredBanner px-6 pb-4 rounded-3xl">
      ...
      {/* Tekst ispod slike */}
      <div style={{ marginTop: '-4px', borderBottomLeftRadius: '10px', borderBottomRightRadius: '10px', paddingBottom: '16px' }} className="bg-white/10 backdrop-blur-md border border-red/15 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.6)] px-4  pb-3 space-y-2">
        ...
        <div style={{ display: 'flex' }}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <h3
              ...
              style={{ color: banner.titleColor, fontSize: '1.8vh', marginTop: 'auto', marginBottom: 'auto' }}
            >
            ...
            <p
              ...
              style={{ color: banner.subtitleColor, fontSize: '1.3vh' }}
            >
